defmodule BattleshipInterfaceWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(BattleshipInterfaceWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(BattleshipInterfaceWeb.Gettext, "errors", msg, opts)
    end
  end
